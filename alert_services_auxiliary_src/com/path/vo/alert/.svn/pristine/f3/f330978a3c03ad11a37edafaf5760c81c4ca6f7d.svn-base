...
/**
 * @AutoGenerated Code
 * @description class CreateSingleSubscriptionSEResp extends ImBaseRequest
 */
@XmlType(propOrder={})
@XmlRootElement(name="createSingleSubscriptionSEResp")
public class CreateSingleSubscriptionSEResp extends ImBaseRequest
{
