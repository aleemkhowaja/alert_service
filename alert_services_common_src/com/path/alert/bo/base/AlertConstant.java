package com.path.alert.bo.base;
...
public class AlertConstant
{
    ...
    public static final String SMS_CONFIG_TYPE ="SMS_CONFIG_TYPE";
    ...
    public static final BigDecimal colTypeLov = new BigDecimal(1652);
    ...
    // Engine Control message status
    public static final BigDecimal MESSAGE_STATUS = new BigDecimal(1654);
    public static final String ALERT_ENGINE_SERVICE_URL = "alertEngine.serviceURL";
    // engine control screen, if fail to retrieve status of engine service
    public static final String UNABLE_TO_RETRIEVE_STATUS = "U";    
    ...
    public static final BigDecimal ALERT_MESSAGES_ROW_LIMIT = new BigDecimal(100);
    public static final String ALERT_ENGINE_SERVICE_NAME = "alertEngBOService";
